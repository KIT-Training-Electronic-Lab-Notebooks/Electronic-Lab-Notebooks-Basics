...
!!! quote ""
	...
	How do I decide, which ELN fits my needs? For assistance on selecting and implementing an ELN the [ELN Guide](https://doi.org/10.4126/FRL01-006425772) and the [ELN Finder](https://eln-finder.ulb.tu-darmstadt.de/home) can be used.
...
!!! quote ""
	...
	There are different categories and providers of ELNs, therefore it can be helpful to use one of the presented tools (ELN Guide, ELN Finder) to select the right ELN.
