...
> The following figure is adapted from [Brandt et al. (2021)](https://doi.org/10.5334/dsj-2021-008) licenced unter [CC BY 4.0](https://creativecommons.org/licenses/by/4.0).

![Logo of Kadi4Mat](attachments/Kadi4Mat_Logo.png)
...
<figure markdown="span">
 ![Conceptual overview of Kadi4Mat](attachments/Kadi4Mat_01.png)
